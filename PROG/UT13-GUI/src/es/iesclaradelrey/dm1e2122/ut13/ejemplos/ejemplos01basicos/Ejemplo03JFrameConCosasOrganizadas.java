...
public class Ejemplo03JFrameConCosasOrganizadas {
	...
	public static void main(String[] args) {
		...
		// Configuramos la forma en la que se distribuirán los componentes
		//panelPpal.setLayout(new FlowLayout()); // Por defecto ya es "Inline", uno detrás de otro.
