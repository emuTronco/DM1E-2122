package es.iesclaradelrey.dm1e2122.ut08.ejercicios.ejercicio08;
...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println("Introduce la operación a realizar. De la forma [conjunto] <operador> [conjunto]. Operadores válidos: +, *, -.");
